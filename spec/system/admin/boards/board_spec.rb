...
RSpec.describe '管理画面/掲示板', type: :system do
  ...
  describe '掲示板一覧' do
    ...
    it '掲示板が一覧表示されること' do
      ...
      boards.each do |board|
        ...
        expect(page).to have_content(I18n.l(board.created_at, format: :long)), '掲示板の作成日時が正しいフォーマットで表示されていません'
      end
    end
  ...
  describe '掲示板詳細' do
    ...
    it '掲示板の詳細情報が表示されること' do
      ...
      expect(page).to have_content(I18n.l(board1.created_at, format: :long)), '掲示板の作成日時が正しいフォーマットで表示されていません'
    end
  end
